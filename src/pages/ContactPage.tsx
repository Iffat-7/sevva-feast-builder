      ...
      <section className="pb-20 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-card border border-border rounded-xl p-8 md:p-10">
              ...
              <div className="mt-10 pt-8 border-t border-border text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Link
                    to="/reservations"
                    className="px-6 py-2.5 bg-gold-gradient text-primary-foreground text-sm tracking-wider rounded hover:opacity-90 transition-opacity"
                  >
                    Book Online
                  </Link>
                  <a
                    href="tel:+923151773177"
                    className="px-6 py-2.5 border border-primary text-primary text-sm tracking-wider rounded hover:bg-primary hover:text-primary-foreground transition-all"
                  >
                    Call Now
                  </a>
                </div>
            ...
            {/* Map */}
            <div className="rounded-xl overflow-hidden border border-border h-[500px] lg:h-auto">
              <iframe
