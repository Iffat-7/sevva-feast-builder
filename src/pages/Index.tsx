        ...
        <div className="container mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden group max-w-5xl mx-auto">
            <img
              ...
              alt="Elegant dining table with traditional Pakistani dishes including biryani, seekh kabab, handi, naan, and desserts"
            ...
            {[
              {
                ...
                desc: "Traditional Pakistani & Turkish-inspired dishes prepared with desi ghee and premium ingredients",
              },
              {
                icon: MapPin,
                title: "Prime Location",
                desc: "Situated near Lake City, Raiwind Road — easily accessible with ample parking",
              },
              {
                icon: Clock,
                title: "Open Daily",
                desc: "Monday through Sunday, 12:00 PM to Midnight — perfect for lunch, dinner, or late-night dining",
              },
              {
                icon: Star,
                title: "Premium Ambience",
                desc: "Elegant family-friendly atmosphere ideal for celebrations, gatherings, and memorable evenings",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-card border border-border rounded-xl p-8 text-center hover:border-primary/30 hover:shadow-gold transition-all duration-500"
              >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="bg-card border border-border rounded-xl p-8 hover:border-primary/30 transition-all duration-300">
