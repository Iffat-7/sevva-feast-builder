...
const ReservationsPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      seating_preference: form.seating,
      ...
      capacity_used: parseInt(form.guests) || 0,
      table_assigned: "",
      confirmation_sent: false,
      confirmation_channel: "pending",
      handled_by: "website_form",
    ...
    try {
      ...
      toast({
        ...
        description: actionType === "cancel"
          ? "Your cancellation request has been sent. Our team will confirm shortly."
          : `Your reservation ID is ${reservationId}. Our team will confirm via phone or WhatsApp.`,
      });
  ...
  return (
    <main id="main-content">
      <PageHeader
        ...
        description="Complete the form below to reserve your table at Sevva."
      />
        ...
        <div className="container mx-auto max-w-2xl">
          <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl p-8 md:p-10">
            ...
            {actionType !== "new" && (
              <div className="mb-6">
                ...
                <input
                  ...
                  placeholder="SVA-XXXXX-XXXX"
                  className="w-full bg-muted text-foreground text-sm rounded-lg px-4 py-3 outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground"
                />
              </div>
            )}
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-muted text-foreground text-sm rounded-lg px-4 py-3 outline-none focus:ring-1 focus:ring-primary"
                    />
                  </div>
                  <div>
                ...
                <div className="mb-8">
                  ...
                  <textarea
                    ...
                    className="w-full bg-muted text-foreground text-sm rounded-lg px-4 py-3 outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground resize-none"
                  />
                </div>
              </>
            )}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-gold-gradient text-primary-foreground font-body text-sm tracking-wider rounded hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              {isLoading
                ? "Submitting..."
                : actionType === "cancel"
